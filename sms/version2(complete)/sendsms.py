...
def main():
    ...
    # 즉시 전송시
    cs.addsms("01043655330", "01035419130", "현재 어느장소에 위험이 처했습니다.") #받는사람/전송하는 사람/메세지
    cs.addsms("01087602435", "01035419130", "현재 어느장소에 위험이 처했습니다.")  # 받는사람/전송하는 사람/메세지
    # 예약 전송시
