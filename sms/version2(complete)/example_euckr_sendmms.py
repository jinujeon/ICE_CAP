...
def main():
    ...
    # 즉시 전송시
    cs.addsms("01012341234", "0212341234", "MMS제목 20바이트까지", "2000바이트까지 텍스트를 전송할 수 있습니다.", "test.jpg")

    # 예약 전송시
    cs.addsms("01012341234", "0212341234", "MMS제목 20바이트까지", "2000바이트까지 텍스트를 전송할 수 있습니다.", "test.jpg", "YYYYMMDDhhmm")
